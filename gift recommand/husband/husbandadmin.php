<?php
$conn=mysqli_connect("localhost","root","","husband");
...
if(isset($_POST['uploadbtn'])){
    ...
    if(strtolower($image_type)=="image/jpg" || strtolower($image_type)=="image/jpeg" || strtolower($image_type)== "image/png")
    {
        if($image_size <1000000){
            ...
            // $query="insert into wedding(name,img) values ('$name','$folder')";
            //  $query="insert into sorrow(name,img) values ('$name','$folder')";
            // $query="insert into anniversary(name,img) values ('$name','$folder')";
            //  $query="insert into engage(name,img) values ('$name','$folder')";
            // $query="insert into valentine(name,img) values ('$name','$folder')";
