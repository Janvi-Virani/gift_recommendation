<?php
$conn=mysqli_connect("localhost","root","","mother");
...
if(isset($_POST['uploadbtn'])){
    ...
    if(strtolower($image_type)=="image/jpg" || strtolower($image_type)=="image/jpeg" || strtolower($image_type)== "image/png")
    {
        if($image_size <1000000){
            ...
            //  $query="insert into goodluck(name,img) values ('$name','$folder')";
            $query="insert into congratulation(name,img) values ('$name','$folder')";
